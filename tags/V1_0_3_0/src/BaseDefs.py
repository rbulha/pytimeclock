class TypeNIcons:
    ...
    ICON[ENTRADA][INVALID]          = BASE_RES_DIR+"Strooper.ico"
    ...
    ICON[SAIDA][INVALID]        = BASE_RES_DIR+"Strooper.ico"
    ...
    ICON[MISC][DAYOFF] = BASE_RES_DIR+"day_off.ico"
    ...
    ICON[S_W][INVALID]   = BASE_RES_DIR+"Strooper.ico"
